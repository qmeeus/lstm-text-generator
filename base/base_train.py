...
class BaseTrain:
    def __init__(self, sess, model, config, logger, data_loader=None):
        ...
        :param config: configs namespace which will contain all the configurations you have specified in the json
    ...
    def train_epoch(self, epoch=None):
        ...
        -loop over the number of iterations in the configs and call the train step
